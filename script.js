const productDetails = [
{
  name: "Nike Jordan 1",
  price: 2900,
  imageUrl: "./images/nike1.jpeg",
  qty: 10,
  heading: "The best for the experience",
  des:
  "Inspired by the original AJ1, the Air Jordan 1 Mid offers fans a chance to follow. " },

{
  name: "High Air Jordan",
  price: 4900,
  imageUrl: "./images/nike2.jpeg",
  qty: 15,
  heading: "You’ve never seen shoes like this",
  des:
  "The radiance lives on in the Nike Air Force 1 '07, the b-ball icon that puts a " },

{
  name: "Nike Nocta",
  price: 1900,
  imageUrl: "./images/nike3.webp",
  qty: 20,
  heading: "The best shoe for the brightest",
  des:
  "Created for the hardwood but taken to the streets, the '80s basketball icon " },

{
  name: "Nike Jordan 12",
  price: 1600,
  imageUrl: "./images/nike4.jpeg",
  qty: 35,
  heading: "High shoes. High comfort. High brightess",
  des:
  "Retro channels '80s vintage back onto the streets while its padded, high-top " },
{
  name: "Nike Nocta",
  price: 1900,
  imageUrl: "./images/nike3.webp",
  ...
  "Retro channels '80s vintage back onto the streets while its padded, high-top " },
{
  ...
  heading: "The best shoe for the brightest",
  des:
  "Created for the hardwood but taken to the streets, the '80s basketball " },

  {
    ...
    heading: "High shoes. High comfort. High brightess",
    des:
    "Retro channels '80s vintage back onto the streets while its padded, " },
  ...
  imageUrl: "./images/nike2.jpeg",
  qty: 25,
  heading: "Your next shoe is not a adidas",
  des:
